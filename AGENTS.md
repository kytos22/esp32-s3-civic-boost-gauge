...
is mounted with the USB connector facing down. Release `v1.2.1` is the current
production baseline.
...
Expected release-build baseline for `v1.2.1`:
...
```powershell
node tools/create_demo_gif.js 1.2.1
```
